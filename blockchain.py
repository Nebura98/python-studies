...
class Blockchain:
    ...
    def proof_of_work(self):
        """
        Generate a proof of work for the open transactions, the hash of the previous block and a random
        number (which is guessed until it fits).
        """
    ...
    def get_balance(self, sender=None):
        ...
        """
        Fetch a list of all sent coin amounts for the given person (empty lists are returned if 
        the person was NOT the sender)
        ...
        We ignore open transactions here because you shouldn't be able to spend coins before the transaction 
        was confirmed + included in a block
        """
    ...
    def add_block(self, block):
        ...
        """
        Check if previous_hash stored in the block is equal to the local blockchain's last block's hash 
        and store the result in a block
        """
